...
function hrToggleExpand() {
  ...
  if (hrChatExpanded) {
    win.style.height = isMobile ? Math.max(360, window.innerHeight - 100) + 'px' : '80vh';
    win.style.width  = isMobile ? 'calc(100vw - 16px)' : '480px';
